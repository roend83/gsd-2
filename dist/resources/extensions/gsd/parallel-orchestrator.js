...
import { existsSync, writeFileSync, readFileSync, renameSync, unlinkSync, mkdirSync, } from "node:fs";
...
import { writeSessionStatus, readAllSessionStatuses, removeSessionStatus, sendSignal, cleanupStaleSessions, } from "./session-status-io.js";
 ...
 */
export function refreshWorkerStatuses(basePath) {
    if (!state)
        return;
