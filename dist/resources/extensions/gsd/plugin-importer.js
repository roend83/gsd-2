...
import { NamespacedRegistry, componentsFromDiscovery, } from './namespaced-registry.js';
...
export class PluginImporter {
    ...
    getImportManifest(selected) {
        ...
        const namespaces = Array.from(new Set(entries.map((e) => e.namespace).filter((n) => n !== undefined))).sort();
        return {
            schemaVersion: '1.0',
