        ...
        async execute(toolCallId, params, signal, onUpdate, ctx) {
            ...
            if (cacheKey === lastSearchKey) {
                ...
                if (consecutiveDupeCount >= MAX_CONSECUTIVE_DUPES) {
                    ...
                    lastSearchKey = "";
                    return {
                        content: [{ type: "text", text: `⚠️ Search loop detected: the query "${params.query}" has been searched ${MAX_CONSECUTIVE_DUPES + 1} times consecutively with identical results. The information you need is already in the previous search results above. Stop searching and use those results to proceed with your task.` }],
                        isError: true,
