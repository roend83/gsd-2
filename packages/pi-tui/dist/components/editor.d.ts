...
export declare class Editor implements Component, Focusable {
    ...
    private lastAutocompleteLookupPrefix;
    private static readonly AUTOCOMPLETE_DEBOUNCE_MS;
    private pastes;
    ...
    private clearLayoutCaches;
    private emitChange;
    private getLayoutLines;
    /**
     ...
     */
    private debouncedTriggerAutocomplete;
    private handlePaste;
    private addNewLine;
    ...
    private clearAutocompleteDebounce;
    dispose(): void;
    isShowingAutocomplete(): boolean;
    private updateAutocomplete;
    private debouncedUpdateAutocompleteSuggestions;
